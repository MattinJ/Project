...
bool Graphics::init(Window& window)
{
	...
	this->resources.addMesh(std::move(suzanne), Vector3(5.0f, 0.0f, -5.0f));
	//this->resources.addMesh(std::move(suzanne), Vector3(5.0f, 0.0f, -6.0f));
	//this->resources.addMesh(std::move(suzanne), Vector3(5.0f, 0.0f, -12.0f));
